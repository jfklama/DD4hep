...
foreach(_expectedTarget DD4hep::TinyXML DD4hep::listcomponents DD4hep::DD4hepGaudiPluginMgr DD4hep::DDParsers DD4hep::DDCore DD4hep::DDCorePlugins DD4hep::DDGDMLPlugins DD4hep::DDPythonPlugins DD4hep::DDRec DD4hep::DDRecPlugins DD4hep::DDDetectors DD4hep::DDCond DD4hep::DDCondPlugins DD4hep::DDAlign DD4hep::DDAlignPlugins DD4hep::DDDigi DD4hep::DDDigiPlugins DD4hep::DDPython DD4hep::pyddg4 DD4hep::DDG4Python DD4hep::DDG4LCIO DD4hep::DDG4 DD4hep::DDG4Plugins DD4hep::DDG4Legacy DD4hep::g4gdmlDisplay DD4hep::g4FromXML DD4hep::DDG4IO DD4hep::ddeve DD4hep::DDEvePlugins DD4hep::DDEve_Interface DD4hep::geoDisplay DD4hep::geoConverter DD4hep::geoPluginRun DD4hep::dumpBfield DD4hep::print_materials DD4hep::materialScan DD4hep::materialBudget DD4hep::graphicalScan DD4hep::teveDisplay DD4hep::dumpdetector DD4hep::test_surfaces DD4hep::test_cellid_position_converter DD4hep::teveLCIO)
...
# Create imported target DD4hep::TinyXML
add_library(DD4hep::TinyXML INTERFACE IMPORTED)

set_target_properties(DD4hep::TinyXML PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "DD4HEP_USE_TINYXML"
)
...
set_target_properties(DD4hep::DDParsers PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "ROOT::Core;Boost::boost;DD4hep::TinyXML"
)
...
set_target_properties(DD4hep::DDCore PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "DD4hep::DDParsers;ROOT::Core;ROOT::Rint;ROOT::Tree;ROOT::Physics;ROOT::Geom;ROOT::GenVector;DD4hep::TinyXML"
)
...
set_target_properties(DD4hep::DDPythonPlugins PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDCore;ROOT::Core;ROOT::PyROOT"
)
...
set_target_properties(DD4hep::DDRec PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "DD4hep::DDCore;/opt/ilcsoft/v02-02-03-pixel/gear/v01-09/lib/libgearsurf.so;/opt/ilcsoft/v02-02-03-pixel/gear/v01-09/lib/libgear.so;/opt/ilcsoft/v02-02-03-pixel/gear/v01-09/lib/libgearxml.so;/opt/ilcsoft/v02-02-03-pixel/CLHEP/2.3.4.3/lib/libCLHEP-2.3.4.3.so;/opt/ilcsoft/v02-02-03-pixel/gear/v01-09/lib/libgeartgeo.so"
)
...
set_target_properties(DD4hep::DDDigi PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "DD4hep::DDCore;Boost::boost;ROOT::Core;ROOT::Geom;ROOT::GenVector;ROOT::RIO"
)
...
# Create imported target DD4hep::DDPython
add_library(DD4hep::DDPython SHARED IMPORTED)

set_target_properties(DD4hep::DDPython PROPERTIES
  INTERFACE_COMPILE_OPTIONS "-Wno-register"
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4;ROOT::Core;Python::Python;ROOT::PyROOT"
)

# Create imported target DD4hep::pyddg4
add_executable(DD4hep::pyddg4 IMPORTED)

# Create imported target DD4hep::DDG4Python
add_library(DD4hep::DDG4Python SHARED IMPORTED)

set_target_properties(DD4hep::DDG4Python PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4;DD4hep::DDPython"
)

# Create imported target DD4hep::DDG4LCIO
add_library(DD4hep::DDG4LCIO SHARED IMPORTED)

set_target_properties(DD4hep::DDG4LCIO PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4;LCIO::LCIO"
)

# Create imported target DD4hep::DDG4
add_library(DD4hep::DDG4 SHARED IMPORTED)

set_target_properties(DD4hep::DDG4 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "DD4hep::DDCore;Geant4::Interface"
)

# Create imported target DD4hep::DDG4Plugins
add_library(DD4hep::DDG4Plugins SHARED IMPORTED)

set_target_properties(DD4hep::DDG4Plugins PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4;DD4hep::DDParsers;DD4hep::TinyXML;ROOT::Core;CLHEP::CLHEP"
)

# Create imported target DD4hep::DDG4Legacy
add_library(DD4hep::DDG4Legacy SHARED IMPORTED)

set_target_properties(DD4hep::DDG4Legacy PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4"
)

# Create imported target DD4hep::g4gdmlDisplay
add_executable(DD4hep::g4gdmlDisplay IMPORTED)

# Create imported target DD4hep::g4FromXML
add_executable(DD4hep::g4FromXML IMPORTED)

# Create imported target DD4hep::DDG4IO
add_library(DD4hep::DDG4IO SHARED IMPORTED)

set_target_properties(DD4hep::DDG4IO PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDG4;DD4hep::DDEve_Interface"
)
...
set_target_properties(DD4hep::DDEvePlugins PROPERTIES
  INTERFACE_LINK_LIBRARIES "DD4hep::DDCore;DD4hep::DDEve_Interface;LCIO::LCIO"
)
...
# Create imported target DD4hep::dumpdetector
add_executable(DD4hep::dumpdetector IMPORTED)
